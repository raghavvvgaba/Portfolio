...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed top-6 left-1/2 -translate-x-1/2 sm:left-6 sm:translate-x-0 z-50 select-none">
        <svg
        ...
        >
          ...
          <div className="flex items-center justify-between px-2 sm:px-4 py-2">
            ...
            <div className="flex items-center justify-around flex-1 gap-1 sm:gap-2">
                ...
                >
                  ...
                  <div
                    className={`
                      ...
                      w-8 h-0.5 sm:w-12 sm:h-1 transition-all duration-300
                      ${activeSection === link.id
              ...
              {/* Separator */}
              <div className="w-px h-6 sm:h-8 bg-white opacity-20 mx-1 sm:mx-2 shrink-0"></div>
              ...
              <div className="flex items-center gap-1 sm:gap-3 shrink-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-[#FCEE0C] transition-all duration-200 hover:bg-[#FCEE0C]/10 p-1.5 sm:p-2 rounded"
                  aria-label="GitHub"
                >
